...
#Libs
from .configs_criaturas import ConfiguracaoMago, ConfiguracaoBasicaAtaque, ConfiguracaoStatus, ConfiguracaoInvocacao
from .configs_efeitos import RecuperarFolego
